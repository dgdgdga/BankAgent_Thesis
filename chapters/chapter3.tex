...
\midrule
FR6 & RAG Agent --- Policy Q\&A & Natural language questions answered from organizational documents with verifiable source citations. Retrieval uses Milvus-indexed chunks, configurable embeddings, permission filtering, and audit records for retrieved and blocked documents. \\
\midrule
...
\midrule
UC2 & Compliance officer & Find policy clauses with verifiable citations & RAG Agent & User asks a regulatory question; query embedded; top-k chunks retrieved and filtered by department and clearance; LLM generates answer with source citations. \\
\midrule
