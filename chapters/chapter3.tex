...
\textbf{ID} & \textbf{Requirement} & \textbf{Description} \\
\midrule
NFR1 & Data Sovereignty & All core data processing must run within the on-premise Docker environment. External API calls transmit only the minimum necessary parameters with no payload logging or retention by third-party providers. \\
\midrule
