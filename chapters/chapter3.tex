...
\midrule
UC3 & Admin. staff & Book a meeting room via natural language & Tool Agent & User describes requirements; intent classified; parameters extracted; available rooms queried; options displayed. \\
\midrule
UC4 & Admin. staff & Detect schedule conflicts & Tool Agent & User specifies attendees and time range; each attendee's calendar checked; conflict report returned with alternatives. \\
\midrule
