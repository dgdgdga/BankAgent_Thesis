...
\bottomrule
\end{tabularx}
\caption{Table 28: Copilot vs. Three Domain Agents --- Role Comparison}
\end{table}
...
\bottomrule
\end{tabularx}
\caption{Table 29: Three-Tier Intent Classification Strategy}
\end{table}
...
\bottomrule
\end{tabularx}
\caption{Table 30: Intent Dispatch --- Frontend Behavior by Classification Result}
\end{table}
