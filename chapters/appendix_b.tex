...
% ======================================================================
\newpage
\addcontentsline{toc}{section}{Appendix B: API Documentation (Selected Endpoints)}
\begin{center}
...
\label{tab:api-tool}
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{0.34\textwidth}>{\RaggedRight\arraybackslash}p{2.0cm}>{\RaggedRight\arraybackslash}X}
\toprule
\textbf{Endpoint} & \textbf{Method} & \textbf{Description} \\
\midrule
