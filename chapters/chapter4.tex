...
\caption{Figure 2: Five-Layer Logical System Architecture --- Web, Gateway, Business Service, AI Service, and Data Layers}
\end{figure}
...
\caption{Figure 3: Data Flow Architecture --- End-to-End Request Processing Across System Layers}
\end{figure}
...
Table 1 summarizes the frontend technology stack.

\vspace{3mm}
\noindent\textbf{Table 1: Frontend Technology Stack Specifications}
...
Table 2 summarizes the backend services.

\vspace{3mm}
\noindent\textbf{Table 2: Backend Service Ecosystem and Technical Orchestration}
...
\caption{Figure 4: JWT Authentication and Email Verification Flow}
\end{figure}
...
\vspace{3mm}
\noindent\textbf{Table 3: Pseudocode --- listDocumentsForUser() Multi-Factor Document Access Rule}
...
Table 4 summarizes the data storage strategy.

\vspace{3mm}
\noindent\textbf{Table 4: Multi-Modal Data Storage Strategy and Layered Access Patterns}
