...
\subsection{Architecture and AI Intent Routing}
...
\subsection{Python LLM Inference Server Integration}
...
\subsection{Five-Layer SQL Whitelist Validation}
...
\subsection{Metadata Caching and Execution}
...
\subsection{Data Structure and Storage Ownership}
...
\subsection{Document Indexing and Chunking Pipeline}
...
\subsection{Permission-Safe Retrieval and Answer Generation}
...
\subsection{API Surface and Orchestration Integration}
...
\subsection{Frontend RAG Workbench and Citation Rendering}
...
\subsection{Synchronization, Deployment, and Testing}
