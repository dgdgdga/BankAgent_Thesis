...
\begin{center}
\textbf{Table 5: Pseudocode --- handleAiIntent() AI Intent Classification and Routing}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 6: Pseudocode --- DeepSeekService.chat() LLM API Call with Fallback}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 7: Pseudocode --- queryRoomsWithStatus() Three-Phase Room Availability Algorithm}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 8: Pseudocode --- bookRoom() Atomic Conflict Check-and-Insert}
\end{center}
...
\begin{center}
\textbf{Table 9: Tool Agent REST API Endpoints}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 10: Pseudocode --- Redis Sorted Set Schedule Operations (add / remove / checkConflicts)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 11: Pseudocode --- POST /tool/check-conflict Attendee-Based Conflict Workflow}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 12: Pseudocode --- Schedule Dual-Write Pattern (MySQL + Redis Consistency)}
\end{center}
...
\begin{center}
\textbf{Table 13: Route Planning Three-Stage Geocoding and Navigation Pipeline}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 14: Pseudocode --- geocodeWithFallback() Multi-Level Address Resolution}
\end{center}
...
\begin{center}
\textbf{Table 15: Code Agent Four-Stage Natural Language to SQL Pipeline}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 16: Pseudocode --- OnnxCodeGenerationService HTTP Proxy to Python Inference Server}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 17: Pseudocode --- validateOperation() SQL Operation Type Check (Layer 1)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 18: Pseudocode --- validateForbiddenKeywords() Keyword Blacklist Scan (Layer 2)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 19: Pseudocode --- validateTableNames() Table Whitelist Verification (Layer 3)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 20: Pseudocode --- validateColumnNames() Column Whitelist Verification (Layer 4)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 21: Pseudocode --- validateComplexity() Query Complexity Limits (Layer 5)}
\end{center}
...
\begin{center}
\textbf{Table 22: SQL Whitelist Validation Rules (Five-Layer Defense)}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 23: Pseudocode --- refreshAllMetadata() Schema Metadata Cache Loading}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 24: Pseudocode --- MetadataCacheManager Cache Lifecycle Management}
\end{center}
...
\needspace{6\baselineskip}
\begin{center}
\textbf{Table 25: Pseudocode --- SqlExecutionService Defense-in-Depth SQL Execution}
\end{center}
