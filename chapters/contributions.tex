...
I authored the banking\_data.sql test dataset with three relational tables — bank\_customer (5 rows, risk levels LOW/MEDIUM/HIGH), bank\_account (7 rows, account types SAVINGS/CHECKING/FIXED), and bank\_transaction (10 rows, transaction types DEPOSIT/WITHDRAW/TRANSFER) — covering diverse NL2SQL scenarios from simple lookups to multi-table JOIN aggregations, and providing a realistic testbed for the generation, validation, and execution pipeline.
