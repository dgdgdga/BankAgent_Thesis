...
\textbf{(1) Containerization \& deployment}

I set up the full deployment pipeline for the platform, bringing all Agent services --- Zhang Zhaoming's Code Agent, Huang Siyuan's RAG Agent, and Lin Chuanbin's initial Tool Agent --- onto a single DigitalOcean Droplet:

- Wrote the docker-compose.yml that starts all services with proper startup order, health checks, and data persistence.
